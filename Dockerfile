...
RUN curl -O http://downloads3.ioncube.com/loader_downloads/ioncube_loaders_lin_x86-64.tar.gz \
    ...
    && cp ioncube/ioncube_loader_lin_7.x.so /usr/lib/php7/modules/ioncube_loader_lin_7.x.so \
    && rm -rf ioncube ioncube_loaders_lin_x86-64.tar.gz

RUN echo "zend_extension=/usr/lib/php7/modules/ioncube_loader_lin_7.x.so" > /etc/php7/conf.d/ioncube.ini
