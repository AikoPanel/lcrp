...
# Tải và cài đặt ionCube Loader
RUN curl -O http://downloads3.ioncube.com/loader_downloads/ioncube_loaders_lin_x86-64.tar.gz \
    && tar xvf ioncube_loaders_lin_x86-64.tar.gz \
    && cp ioncube/ioncube_loader_lin_7.4.so /usr/lib/php7/modules/ \
    && rm -rf ioncube ioncube_loaders_lin_x86-64.tar.gz

# Cấu hình ionCube Loader
RUN echo "zend_extension=/usr/lib/php7/modules/ioncube_loader_lin_7.4.so" > /etc/php7/conf.d/00_ioncube.ini
